...
<body>
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-md-2">
                <ul class="navbar-nav bg-secondary text-center" style="min-height: 120vh;">
                    ...
                    $select_image = "select * from `user_table` where user_name='$username'";
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="users_logout.php">
                            Logout
                        </a>
                    </li>
                </ul>
